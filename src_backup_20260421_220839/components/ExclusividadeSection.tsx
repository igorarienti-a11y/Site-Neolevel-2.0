...
export function ExclusividadeSection() {
  ...
  return (
    <section id="processo-seletivo" className="py-20 md:py-28 px-4 sm:px-6 relative overflow-hidden" style={{ background: "rgba(30,30,30,0.85)" }}>
      ...
      <div className="max-w-6xl mx-auto" ref={ref}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center mb-16 md:mb-20">
          <motion.div
